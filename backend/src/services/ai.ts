...
Formatting: your reply is rendered as Markdown in the mobile app. Use **bold** for key terms, bullet lists ("- item") for steps, and short paragraphs. Keep replies tight — 2–4 short paragraphs or a short list.${athleteContext}`;
